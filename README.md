...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/rsous/GuessMyNumber"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://rsous.github.io/GuessMyNumber/">View Demo</a>
    ·
    <a href="https://github.com/rsous/GuessMyNumber/issues">Report Bug</a>
    ·
    <a href="https://github.com/rsous/GuessMyNumber/issues">Request Feature</a>
  </p>
</p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/rsous/GuessMyNumber.git
   ```
...
See the [open issues](https://github.com/rsous/GuessMyNumber/issues) for a list of proposed features (and known issues).
